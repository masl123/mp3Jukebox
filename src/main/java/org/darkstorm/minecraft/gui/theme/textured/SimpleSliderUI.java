...
public class SimpleSliderUI extends AbstractComponentUI<Slider> {
	private TexturedTheme theme;

	public SimpleSliderUI(TexturedTheme texturedTheme) {
		super(Slider.class);
	...
	protected void renderComponent(Slider component) {
		...
		if(content != null) {
			...
			fontRenderer.drawString(content, component.getWidth() - fontRenderer.getStringWidth(content), 0, RenderUtil.toRGBA(foreground));
		}
